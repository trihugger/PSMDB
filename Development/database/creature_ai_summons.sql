...
CREATE TABLE `creature_ai_summons` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1065 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='EventAI Summoning Locations';
...
-- Dump completed on 2009-04-18 20:11:25
