...
CREATE TABLE `creature_ai_summons` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1057 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='EventAI Summoning Locations';
...
-- Dump completed on 2009-04-09 17:02:32
